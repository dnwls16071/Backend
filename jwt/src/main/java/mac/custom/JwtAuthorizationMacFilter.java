...
public class JwtAuthorizationMacFilter extends OncePerRequestFilter {
    ...
    private final MacTokenVerifier verifier;
    ...
    public JwtAuthorizationMacFilter(MacTokenVerifier verifier,
    ...
    private void reject(HttpServletRequest request, HttpServletResponse response, AuthenticationException e) throws ServletException, IOException {
